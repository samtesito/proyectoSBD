...
VALUES (TO_DATE('2026-02-20','YYYY-MM-DD'), 800001, 900001, 'A'); -- Adulto
INSERT INTO ENTRADAS (f_inicio, nro_fact, nro, tipo) VALUES 
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800001, 900002, 'M'),  -- Menor
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800001, 900003, 'A'),  -- Adulto
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800002, 900004, 'A'),
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800003, 900005, 'M'),
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800004, 900006, 'A'),
(TO_DATE('2026-02-20','YYYY-MM-DD'), 800005, 900007, 'M');
