...
(2011, TO_DATE('2024-01-01','YYYY-MM-DD'), 9.99, null),
(2012, TO_DATE('2024-01-01','YYYY-MM-DD'), 19.99, null), 
(2013, TO_DATE('2024-01-01','YYYY-MM-DD'), 24.99, null), 
(2014, TO_DATE('2024-01-01','YYYY-MM-DD'), 79.99, null),
(3011, TO_DATE('2024-01-01','YYYY-MM-DD'), 100, null),                                 
(3012, TO_DATE('2024-01-01','YYYY-MM-DD'), 250, null),   
(3013, TO_DATE('2024-01-01','YYYY-MM-DD'), 500, NULL),    
(3014, TO_DATE('2024-01-01','YYYY-MM-DD'), 1000, NULL),    
(408, TO_DATE('2024-01-01','YYYY-MM-DD'), 14.99, NULL),    
(409, TO_DATE('2024-01-01','YYYY-MM-DD'), 324.99, NULL),    
(410, TO_DATE('2024-01-01','YYYY-MM-DD'), 124.99, NULL),    
(411, TO_DATE('2024-01-01','YYYY-MM-DD'), 234.99, NULL), 
(412, TO_DATE('2024-01-01','YYYY-MM-DD'), 402.99, NULL),    
(413, TO_DATE('2024-01-01','YYYY-MM-DD'), 122.99, NULL),    
(414, TO_DATE('2024-01-01','YYYY-MM-DD'), 40.99, NULL),    
(415, TO_DATE('2024-01-01','YYYY-MM-DD'), 48.99, NULL);       
